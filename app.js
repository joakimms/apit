...
$(document).ready(function () {
  ...
  $(".reset").on("click", function () {
    $(".chest").remove();
    $(".gameBoard .gametile").removeClass("dirt water stone off").addClass(
      defaultTile,
    );
    score = 0;
    chestCount = 0;
...
function gem(tile) {
  ...
  $(tile).append(
    "<img class='gem' src='http://adrianpayne.me/game/assets/images/gem.png' />",
  );
...
function chest(tile) {
  ...
  $(".chest").click(function () {
    ...
    $(this).append(
      "<img class='star' src='http://adrianpayne.me/game/assets/images/star.png' />",
    );
